...
public class ClientConnectionHandlerImpl implements ClientConnectionHandler {
    ...
    @Override
    public void handleConnection(ObservableConnection<IncomingMessage, OutgoingMessage> observableConnection) {
     ...
     */
    private void handleIncomingMessages(ObservableConnection<IncomingMessage, OutgoingMessage> observableConnection, Observable<IncomingMessage> incomingMessageObservable) {
        incomingMessageObservable.subscribe(incomingMessage -> handleIncomingMessage(observableConnection, incomingMessage));
    }
     ...
     */
    private void handleIncomingMessage(ObservableConnection<IncomingMessage, OutgoingMessage> observableConnection, IncomingMessage incomingMessage) {
